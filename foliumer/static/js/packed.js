...
document.addEventListener('DOMContentLoaded',function(e){toggle_backdrop();});function save_page(){toggle_global_spinner();var obj={};obj['page_id']=window.page_id;var editables=document.querySelectorAll('.admin-editable');obj['editables']=[];for(var i=0;i<editables.length;i++){var editable={"editable_id":editables[i].getAttribute('data-editable-id'),"text":editables[i].innerHTML};obj['editables'].push(editable);}
