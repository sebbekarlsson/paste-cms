...
tmp_data['dy']-=0.1;var next_top=parseInt(tmp_data['menu'].style.top.replace('px',''))+tmp_data['dy'];if((next_top>=0&&drop)||(!drop&&next_top<=-tmp_data['menu_height'])){clearInterval(inter);}
